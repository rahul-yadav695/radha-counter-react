...
const winners = [
    { id: 1, name: "Vaishali", email: "vais************@gmail.com" },
    { id: 2, name: "Yogesh Rawat", email: "yoge************@gmail.com" },
    { id: 3, name: "Vinod Qadri", email: "vino************@gmail.com" },
    { id: 4, name: "Pooja Sharma", email: "pooj************@gmail.com" },
    { id: 5, name: "Vishnu Sarswat", email: "vish************@gmail.com" }
];
...
const GiveawayWinnerSection = () => {
    return (
        <div className="w-full bg-[#FFF7E7] py-16 px-4 flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-pink-500 mt-6 flex items-center gap-3">
                🌸 राधे राधे 🌸
            </h2>
