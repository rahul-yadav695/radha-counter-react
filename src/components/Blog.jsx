    ...
    <>
      <div className="max-w-7xl mx-auto px-4 py-10">
         ...
         <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link to='/radha-blog' className="bg-white rounded-xl shadow hover:shadow-xl overflow-hidden transition">
            ...
            <div className="p-5">
              ...
              <p className="text-gray-600 mt-3">Chanting the holy name of Radha...</p>
            </div>
          </Link>
          ...
          <Link to='/radha-blog' className="bg-white rounded-xl shadow hover:shadow-xl overflow-hidden transition">
            ...
            <div className="p-5">
              ...
              <p className="text-gray-500 text-sm mt-1">Admin • September 6, 2025</p>
              <p className="text-gray-600 mt-3">Anxiety and stress affect the mind...</p>
            </div>
          </Link>
          ...
          <Link to='/radha-blog' className="bg-white rounded-xl shadow hover:shadow-xl overflow-hidden transition">
            ...
            <div className="p-5">
              ...
              <p className="text-gray-500 text-sm mt-1">Admin • September 6, 2025</p>
              <p className="text-gray-600 mt-3">The chanting of Radha Naam Jap...</p>
            </div>
          </Link>
       ...
       <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 p-4">
        ...
        <Link to="/blog/1" className="bg-white rounded-2xl shadow-md hover:shadow-xl transition p-4 cursor-pointer">
          ...
          <p className="mt-3 text-gray-800 font-medium">Top Free Apps for Radha Naam Jap: Chant with...</p>
          <p className='mt-3 text-gray-800 opacity-50'>Admin October 7, 2025</p>
          <p className='mt-3 text-gray-800 opacity-90'> Discover the best free apps...</p>
        </Link>
